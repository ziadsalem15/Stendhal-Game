...
public class AchievementsXMLLoaderTest {
	 ...
	 */
	@Test
	public void TestLoading() throws URISyntaxException, SAXException, IOException {
		AchievementsXMLLoader loader = new AchievementsXMLLoader(new URI("testsemos.xml"));
		loader.load();
